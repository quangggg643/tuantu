    ...
    <>
      ...
      <div className="login-wrap">
        <div className="login-card">
          ...
          <p className="hint-tip">📱 Liên hệ Zalo Nguyễn Tuấn Tú (0397088175) để lấy pass</p>
        </div>
      </div>
      <style>{`
        ...
        <header>
          <div className="inner">
            <div className="hd-left">
              ...
              <div><h1>Nguyễn Tuấn Tú</h1><p>✨ Quản lý dữ liệu</p></div>
            </div>
          ...
          <div className="card csv-card">
            <div className="card-title">
              ...
              <div>
                ...
                <p>Nhắn cho Nguyễn Tuấn Tú (0397088175) hướng dẫn lấy file CSV nếu bạn chưa biết</p>
              </div>
            </div>
